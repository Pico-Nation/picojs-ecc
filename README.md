[![NPM](https://img.shields.io/npm/v/picojs-ecc.svg)](https://www.npmjs.org/package/picojs-ecc)
[![Build Status](https://travis-ci.org/PICOIO/picojs-ecc.svg?branch=master)](https://travis-ci.org/PICOIO/picojs-ecc)
...
-   Install with: `yarn add picojs-ecc`
-   Html script tag, see [releases](https://github.com/PICOIO/picojs-ecc/releases) for the correct **version** and its matching script **integrity** hash.
...
<head>
  <meta charset="utf-8">
  <!--
  sha512-cL+IQQaQ586s9DrXfGtDheRpj5iDKh2M+xlpfwbhNjRIp4BGQ1fkM/vB4Ta8mc+f51YBW9sJiPcyMDIreJe6gQ== lib/picojs-ecc.js
  sha512-dYFDmK/d9r3/NCp6toLtfkwOjSMRBaEzaGAx1tfRItC0nsI0hVLERk05iNBQR7uDNI7ludYhcBI4vUiFHdjsTQ== lib/picojs-ecc.min.js
  sha512-eq1SCoSe38uR1UVuQMwR73VgY8qKTBDc87n2nIiC5WLhn1o2y1U6c5wY8lrigVX7INM8fM0PxDlMX5WvpghKig== lib/picojs-ecc.min.js.map
  -->
  <script src="https://cdn.jsdelivr.net/npm/picojs-ecc@4.0.4/lib/picojs-ecc.min.js"
    integrity="sha512-dYFDmK/d9r3/NCp6toLtfkwOjSMRBaEzaGAx1tfRItC0nsI0hVLERk05iNBQR7uDNI7ludYhcBI4vUiFHdjsTQ=="
    crossorigin="anonymous"></script>

</head>
<body>
  See console object: picojs_ecc
</body>
</html>
```
...
-   `wif` **[wif](#wif)** 
-   `pubkey_prefix` **[string](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)** public key prefix (optional, default `'PICO'`)
...
-   `pubkey` **[pubkey](#pubkey)** like PICOKey..
-   `pubkey_prefix` **[string](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)**  (optional, default `'PICO'`)
...
-   `signature` **([String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String) \| [Buffer](https://nodejs.org/api/buffer.html))** (PICObase58sig.., Hex, Buffer)
...
```js
let {PrivateKey, PublicKey, Signature, Aes, key_utils, config} = require('picojs-ecc')
...
```bash
git clone https://github.com/PICOIO/picojs-ecc.git
cd picojs-ecc
yarn
yarn build_browser
# builds: ./dist/picojs-ecc.js
# Verify release hash
```

```html
<script src=picojs-ecc.js></script>
```
