...
/**
  ...
  @param {string} [pubkey_prefix = 'PICO']
*/
function PublicKey(Q, pubkey_prefix = 'PICO') {
    if(typeof Q === 'string') {
     ...
     * @arg {string} [pubkey_prefix = 'PICO'] - public key prefix
    */
    function toString(pubkey_prefix = 'PICO') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'PICO']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'PICO') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'PICO') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'PICO') {
