...
ecc.randomKey().then(privateKey => {
  ...
  console.log('Public Key:\t', ecc.privateToPublic(privateKey)) // PICOkey...
})
    */
    ...
    */
    privateToPublic: (wif, pubkey_prefix = 'PICO') =>
      PrivateKey(wif).toPublic().toString(pubkey_prefix),

    /**
        @arg {pubkey} pubkey - like PICOKey..
        @arg {string} [pubkey_prefix = 'PICO']

        @return {boolean} valid

        @example ecc.isValidPublic(pubkey) === true
    */
    isValidPublic: (pubkey, pubkey_prefix = 'PICO') =>
    ...
    */
    ...
    /**
        ...
        @arg {String|Buffer} signature (PICObase58sig.., Hex, Buffer)
